Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/DomenicoGonnelli/N64GameCore"
  spec.platform     = :ios, "14.0"
  spec.source       = { :git => "https://github.com/DomenicoGonnelli/N64GameCore.git" }

  spec.author             = { "Domenico Gonnelli" => "domenico.gonnelli@outlook.it" }
  
  spec.source_files  = "N64GameCore/**/*.{h,m,mm,cpp,swift}", "N64GameCore/N64GameCore.h", "Mupen64Plus/mupen64plus-core/src/backends/api/video_capture_backend.c", "Mupen64Plus/mupen64plus-core/src/device/dd/dd_controller.c", "Mupen64Plus/mupen64plus-core/src/device/controllers/paks/biopak.c", "Mupen64Plus/mupen64plus-core/src/backends/dummy_video_capture.c", "Mupen64Plus/mupen64plus-core/src/api/**/*.{h,hpp}", "Mupen64Plus/mupen64plus-core/src/backends/**/*.{h,hpp}", "Mupen64Plus/mupen64plus-core/src/device/**/*.{h,hpp}", "Mupen64Plus/mupen64plus-core/src/main/**/*.{h,hpp}", "Mupen64Plus/mupen64plus-core/src/osal/**/*.{h,hpp}", "Mupen64Plus/mupen64plus-core/src/osd/**/*.{h,hpp}", "Mupen64Plus/mupen64plus-core/src/plugin/**/*.{h,hpp}", "Mupen64Plus/mupen64plus-core/subprojects/**/*.{h,hpp}", "libMupen64Plus/SDL/*.{h,hpp}"
  ...
  spec.subspec 'RSP' do |rsp|
    rsp.source_files  = "Mupen64Plus/mupen64plus-rsp-hle/src/*.{h,c}", "N64GameCore-RSP/plugin_delta.c"
  ...
  spec.subspec 'Video' do |video|
    ...
    video.xcconfig = {
      "HEADER_SEARCH_PATHS" => '"$(PODS_ROOT)/Headers/Private/N64GameCore/Mupen64Plus/GLideN64/src" "$(PODS_ROOT)/Headers/Private/N64GameCore/Mupen64Plus/GLideN64/src/inc" "$(PODS_ROOT)/Headers/Private/N64GameCore/Mupen64Plus/GLideN64/src" "$(PODS_ROOT)/Headers/Private/N64GameCore/Mupen64Plus/GLideN64/src/osal" "$(PODS_ROOT)/Headers/Private/N64GameCore/Mupen64Plus/libpng"',
      "USER_HEADER_SEARCH_PATHS" => '"$(PODS_ROOT)/Headers/Private/N64GameCore/N64GameCore-Video/**" "$(PODS_ROOT)/Headers/Private/N64GameCore/Mupen64Plus/GLideN64/src" "$(PODS_ROOT)/Headers/Private/N64GameCore/Mupen64Plus/mupen64plus-core/src" "$(PODS_ROOT)/Headers/Private/N64GameCore/Mupen64Plus/GLideN64/src/GLideNHQ/inc" "$(PODS_ROOT)/Headers/Private/N64GameCore/Mupen64Plus/GLideN64/src/osal" "$(PODS_ROOT)/Headers/Private/N64GameCore/Mupen64Plus/GLideN64/src/GLideNHQ" "$(PODS_ROOT)/Headers/Public/N64GameCore/N64GameCore/**"',
